...
fun PlaceOfWorkScreen(
    ...
    Column(
        ...
        Button(onClick = { onNavigateNext2() }) {
            Text(text = stringResource(R.string.select_region))
        }
    }
}
...
@Composable
fun PlaceOfWorkScreenPreview() {
    AppTheme {
        PlaceOfWorkScreen(onNavigateNext = {}, onNavigateNext2 = {})
    }
}
...
@Composable
fun PlaceOfWorkScreenDarkPreview() {
    AppTheme {
        PlaceOfWorkScreen(onNavigateNext = {}, onNavigateNext2 = {})
    }
}
